...
function printQuote() {
  //** */ the printQuote function will take for the getRandomQuote to add it to the page and check if their are any additional strings to add
  ...
  if ( randomQuote.citation ) { 
    //** */ this will add the citation if there is one 
